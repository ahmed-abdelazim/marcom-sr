...
function mycert($type,$cert_number){
$ch = curl_init();

curl_setopt($ch, CURLOPT_URL, 'http://marcomtrade.com/sr_new/controllers/products?_method=certificate&type='.$type.'&cert_number='.$cert_number);
curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
